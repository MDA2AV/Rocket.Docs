...
Structure for a TCP server, expects a single ring per request/read, in the case the receiving request is split into multiple rings this approach will not work properly, use if you fully control how the request is generated.
